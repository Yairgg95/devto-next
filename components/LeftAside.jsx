...
import CreateAccountCard from "./CreatedAccountCard";
...
export default function LeftAside() {
  ...
  return (
    <aside className="hidden col-start-1 col-end-2  row-start-2 p-4 mt-4 md:flex flex-col w-full min-h-dvh ml-2 ">
